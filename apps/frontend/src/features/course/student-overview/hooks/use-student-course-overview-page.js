...
export const useStudentCourseOverviewPage = () => {
  ...
  const studentCourseOverviewQuery =
    useGetStudentCourseOverview(normalizedCourseId);
  ...
  const contentStats = useMemo(() => buildContentStats(sections), [sections]);
  ...
  const isError =
    studentCourseOverviewQuery.isError || studentCourseCurriculumQuery.isError;

  const error =
    studentCourseOverviewQuery.error ?? studentCourseCurriculumQuery.error;
