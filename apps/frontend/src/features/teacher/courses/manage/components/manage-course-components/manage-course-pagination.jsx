...
import { COURSE_PAGE_LIMIT_OPTIONS } from "../../constants/course-pagination";
import AppPagination from "@/shared/ui/navigation/app-pagination";
    ...
    <section className="border border-black/10 bg-white p-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <p className="text-sm text-black/60">
          Showing <span className="font-medium text-black">{startItem}</span>
          {" - "}
