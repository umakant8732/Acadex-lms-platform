...
const getLessonErrorMessage = (lessonError) => {
  if (!lessonError) {
    return "";
  }
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              disabled={isSubmitting}
              onChange={(event) =>
                onFieldChange("lectures", event.target.value)
              }
              className="mt-2 w-full border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-black"
            />
          ...
          <div>
            ...
            <input
              ...
              disabled={isSubmitting}
              onChange={(event) =>
                onFieldChange("projects", event.target.value)
              }
              className="mt-2 w-full border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-black"
            />
            ...
            >
              ...
              <div className="mt-5 space-y-3">
                {section.lessons.map((lesson, lessonIndex) => (
                  <div
                    key={lesson._id || `lesson-${sectionIndex}-${lessonIndex}`}
                  >
