...
import { getLevelClass } from "../../helpers/get-level-class";
import { getStatusClass } from "../../helpers/get-status-class";
import { courseThumbnailAcceptAttribute } from "../../constants/course-thumbnail-upload";
import { formatCoursePrice } from "@/shared/utils/course/format-course-price";

const ManageCourseTableRow = ({
  course,
  onViewClick,
  onEditClick,
  onDeleteClick,
