...
import { useStudentCourseLibrary } from "../../../../../features/course/student-library/hooks/use-student-course-library";
...
export const useStudentHomePage = () => {
  ...
  const categoryCount = useMemo(() => {
    return new Set(
      studentCourses.map((course) => course.category).filter(Boolean),
    ).size;
  }, [studentCourses]);
