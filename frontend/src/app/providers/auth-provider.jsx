...
const AuthProvider = ({ children }) => {
  ...
  const { data, isLoading, isSuccess, isError, refetch } = useGetCurrentUser();

  const { mutateAsync: refreshSession, isPending: isRefreshing } =
    useRefreshToken();
  ...
  }, [data, dispatch, isError, isSuccess, refetch, refreshSession]);
