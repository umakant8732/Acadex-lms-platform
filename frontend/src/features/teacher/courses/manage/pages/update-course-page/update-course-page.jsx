...
import UpdateCourseContent from "../../components/update-course-components/update-course-content";
import { useCourseDetailsPage } from "../../hooks/use-course-details-page";

const UpdateCoursePage = () => {
  const { courseId, course, isLoading, isError, error, refetchCourse } =
