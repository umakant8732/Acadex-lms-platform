...
import { useGetStudentCourseOverview } from "../../../courses/overview/queries/use-get-student-course-overview";
...
export const useStudentWatchPage = () => {
  ...
  useEffect(() => {
    ...
    navigate(
      `/student/courses/${normalizedCourseId}/learn/${activeLesson._id}`,
      {
        replace: true,
      },
    );
