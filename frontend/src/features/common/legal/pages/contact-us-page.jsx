...
const ContactUsPage = () => {
  return (
    <LegalPageLayout title="Contact Us" subtitle="Reach out to Acadex support">
      <div className="space-y-8 text-sm text-black/70">
        <p className="text-base text-black/80 font-medium leading-relaxed">
          Have questions about a course, payment, or institutional access? Get
          in touch with us using the channels below. We try to respond to all
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4">
          ...
          <div className="border border-black/10 p-6 flex flex-col justify-between hover:border-black/20 transition-all rounded-sm">
            ...
            <p className="text-black font-semibold text-sm">+91 9588418970</p>
            <p className="text-xs text-black/50 mt-1">
