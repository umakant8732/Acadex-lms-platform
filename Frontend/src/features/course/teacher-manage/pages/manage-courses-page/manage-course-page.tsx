...
import ManageCourseTable from '../../components/manage-course-components/manage-course-table.js'
import DeleteCourseModal from '../../components/manage-course-components/delete-course-modal.js'
import ManageCourseFilters from '../../components/manage-course-components/manage-course-filters.js'
import ManageCoursePagination from '../../components/manage-course-components/manage-course-pagination.js'
  ...
  return (
    <section className='space-y-6'>
      ...
      <DeleteCourseModal
        ...
        errorMessage={(deleteCourseError as any)?.response?.data?.message}
