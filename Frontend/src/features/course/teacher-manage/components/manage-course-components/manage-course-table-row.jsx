        ...
        <div className='flex items-center gap-4'>
          ...
          >
            ...
            {isThumbnailUploading ? (
              ...
              <div className='pointer-events-none absolute inset-x-0 bottom-0 bg-black/78 px-1 py-1 text-center text-[9px] font-medium uppercase leading-none whitespace-nowrap text-white'>
