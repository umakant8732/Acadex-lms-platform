  ...
  return (
    <div className="relative hidden items-center justify-center overflow-hidden bg-black p-16 text-white lg:flex">
      ...
      <div className="relative z-10 max-w-xl">
        ...
        >
          Modern learning platform for students and teachers to build real-world
          development skills.
        </motion.p>
        ...
        >
          <div>
            ...
            <p className="mt-2 text-sm text-white/50">Students</p>
          </div>

          <div>
            <h3 className="text-4xl font-semibold">120+</h3>

            <p className="mt-2 text-sm text-white/50">Courses</p>
          </div>

          <div>
            <h3 className="text-4xl font-semibold">40+</h3>

            <p className="mt-2 text-sm text-white/50">Teachers</p>
          </div>
        </motion.div>
      </div>
    </div>
