...
import LectureCurriculumHeader from "./lecture-curriculum-header";
import LectureLessonRow from "./lecture-lesson-row";

const LectureCurriculumContent = ({
  curriculum,
  videoInputRef,
  onUploadButtonClick,
  onVideoFileChange,
                  ...
                  section.lessons.map((lesson) => {
                    ...
                    return (
                      <LectureLessonRow
                        ...
                        isPlaybackLoading={
                          !!lesson.lecture?._id &&
                          playbackLoadingLectureId === lesson.lecture._id
                        }
                        onWatchLecture={onWatchLecture}
                        onRetryClick={onRetryClick}
                        isRetrying={
                          !!lesson.lecture?._id &&
                          retryLoadingLectureId === lesson.lecture._id
                        }
