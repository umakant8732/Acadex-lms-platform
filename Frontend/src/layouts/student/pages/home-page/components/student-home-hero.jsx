const StudentHomeHero = ({ totalCourses, categoryCount }) => {
  return (
      ...
      <div className="mt-5 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-black/60 md:text-base">
            Browse published courses, compare pricing and review the curriculum
            before you enroll in your next learning path.
          </p>
        </div>
