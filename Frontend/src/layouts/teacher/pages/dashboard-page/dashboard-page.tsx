...
import AnalyticsCard from './components/dashboard-analytics-card.js'
import DashboardStats from './components/dashboard-stats.js'
import RecentCourses from './components/dashboard-recent-courses.js'
import RecentStudents from './components/dashboard-recent-students.js'
