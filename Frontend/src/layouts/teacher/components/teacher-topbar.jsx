...
import NotificationButton from "./teacher-topbar/notification-button";
import SearchBox from "./teacher-topbar/search-box";
import TeacherProfileDropdown from "./teacher-topbar/teacher-profile-dropdown";

const TeacherTopbar = ({ onMenuToggle }) => {
  return (
