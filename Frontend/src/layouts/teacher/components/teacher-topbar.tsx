...
import NotificationButton from './teacher-topbar/notification-button.js'
import SearchBox from './teacher-topbar/search-box.js'
import TeacherProfileDropdown from './teacher-topbar/teacher-profile-dropdown.js'

export interface TeacherTopbarProps {
  onMenuToggle?: () => void
}

const TeacherTopbar: React.FC<TeacherTopbarProps> = ({ onMenuToggle }) => {
  return (
